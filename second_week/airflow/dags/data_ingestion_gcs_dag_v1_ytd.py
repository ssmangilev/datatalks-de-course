...
dataset_url = f"https://github.com/DataTalksClub/nyc-tlc-data/releases/download/yellow/"
...
def yellow_taxi_data_dag_ytd():
    """
    ### DAG for an upload yellow taxi data from github to GCS
    ...
    def build_csv_filename() -> str:
        ...
        filename = f"yellow_tripdata_{execution_date.year}-{month}.csv.gz"
        return filename
